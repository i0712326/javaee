...
define(function(require,exports,module){
	...
	var $travelByDestTemp	= $(productTempl).find('#travelPageByDestTemp').html();
	...
	var TravelByDestView = Backbone.View.extend({
		className : 'container',
		template : Handlebars.compile($travelByDestTemp),
		render : function(){
			var data = this.model.toJSON();
			this.$el.html(this.template(data));
			return this.$el;
	...
	return {
		...
		TravelByDestView : TravelByDestView
	}
