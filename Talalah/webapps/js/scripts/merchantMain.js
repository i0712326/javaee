...
requirejs.config({
    ...
    paths: {
    	...
    	// template bundles
    	merchantHomeTemp 	: '/Talalah/template/merchant/home/home.html',
    	productTemp			: '/Talalah/template/merchant/products/product.html',
    	messageInboxTemp	: '/Talalah/template/merchant/messages/message.inbox.html',
    	messageSentTemp		: '/Talalah/template/merchant/messages/message.sent.html',
    	orderTemp			: '/Talalah/template/merchant/order/order.temp.html',
    	historyTemp			: '/Talalah/template/merchant/history/history.temp.html'
    },
    shim : {
    	jquery 		: { exports : '$' },
