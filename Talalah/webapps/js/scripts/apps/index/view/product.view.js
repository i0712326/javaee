...
define(function(require,exports,module){
	...
	var ProductView = Backbone.View.extend({
		...
		render : function(){
			...
			var id	= data.id;
			var img = data.img
			var path = contentMerchant+'/'+mcc+'/'+mcId+'/'+id+'/'+img;
	...
	var ProductMerchantCodeView = Backbone.View.extend({
		initialize : function(){
			this.page = 1;
			this.searchTvlPage = 1;
			this.searchAdvTvlPage = 1;
			this.searchItePage = 1;
			_.bindAll(this,"render");
			this.model.bind('change',this.render);
		},
		className : 'container',
		...
		events : {
			...
			'click #searchmore'		: 'doSearchTvlMore',
			'click #advsearchmore'	: 'doAdvSearchTvlMore',
		...
		doTvlSearch : function(e){
			e.preventDefault();
			event.productMerchantCode.doTvlSearch(this.searchTvlPage,this, ProductViews);
			this.searchTvlPage++;
		},
		doSearchTvlMore : function(e){
			e.preventDefault();
			event.productMerchantCode.doTvlSearchMore(this.searchTvlPage,this, ProductViews);
			this.searchTvlPage++;
		},
		doAdvTvlSearch : function(e){
			e.preventDefault();
			event.productMerchantCode.doAdvTvlSearch(this.searchAdvTvlPage, this, ProductViews);
			this.searchAdvTvlPage++;
		},
		doAdvSearchTvlMore : function(e){
			e.preventDefault();
			event.productMerchantCode.doAdvTvlSearchMore(this.searchAdvTvlPage, this, ProductViews);
			this.searchAdvTvlPage++;
		},
		doIteSearch : function(e){
			e.preventDefault();
			event.productMerchantCode.doIteSearch(this.searchItePage, this, ProductViews);
			this.searchItePage++;
		}
	});
