...
define(function(require, exports, module){
	...
	var user 		= require('/TalalahMerchant/js/scripts/lib/userUrl.js');
	var customer 	= require('/TalalahMerchant/js/scripts/lib/customerUrl.js');
	var item		= require('/TalalahMerchant/js/scripts/lib/itemProductUrl.js');
	var merchant 	= require('/TalalahMerchant/js/scripts/lib/merchantUrl.js');
	var order 		= require('/TalalahMerchant/js/scripts/lib/orderUrl.js');
	var product 	= require('/TalalahMerchant/js/scripts/lib/productUrl.js');
	var shipping 	= require('/TalalahMerchant/js/scripts/lib/shippingUrl.js');
	var travel 		= require('/TalalahMerchant/js/scripts/lib/travelProductUrl.js');
	...
	var InitContext = function(){
		...
		this.getInitContext = function(){
			...
			talalah.com.client.app.page.content = 'http://localhost:8080/TalalahContents/content/merchant';
